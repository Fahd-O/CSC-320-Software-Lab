    ...
    <main>
        <div class="container">
            ...
            <?php
                for ($i=1; $i <= $total; $i++)
                { 
                    if (isset($_POST['choice'])) //supposed to check if question has been answered and if unanswered, the styling below is suppoed to be applied
                    {
                        echo "<button class='qLinkBtn'><a class='qLink' href='question.php?n=$i'>$i</a></button>";
                    }
                    else //The styling below is suppoed to be applied only if question has been answered.
                    {
